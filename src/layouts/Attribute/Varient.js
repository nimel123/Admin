    ...
    >
      <div className="city-container">
        ...
        >
          ...
          >
            <div>
              <span style={{ fontWeight: "bold", fontSize: 26 }}>Varients Lists</span>
              <br />
              <span style={{ fontSize: 17 }}>View and manage all varients</span>
            </div>
            <div>
              <Button
                style={{
            ...
            >
              <thead>
                <tr>
                  ...
                  <th style={headerCell}>Varients Name</th>
